...
export default function WorkProgressScreen() {
  ...
  const handleSubmitReview = () => {
    ...
    if (!isSubmitted) {
      // Transition to thank you feedback state view layout
      setIsSubmitted(true);
    } else {
      // Final submission dismissal hook path
      bottomSheetModalRef.current?.dismiss();
        ...
        <SafeAreaView style={styles.container} edges={['top']}>
          ...
          <View style={styles.headerRow}>
            ...
            <View style={styles.ticketHeaderCenter}>
              <Text style={styles.headerTicketLabel}>Ticket Number</Text>
              <Text style={styles.headerTicketId}>#TK-88394</Text>
            </View>
            <View style={{ width: 40 }} />
          </View>
          ...
          >
            <BottomSheetView style={styles.sheetContainer}>
              ...
              <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.sheetScrollContent}>
                ...
                {/* CONDITIONAL CONDITIONAL EVALUATION CHIPS AND TEXTFIELD LAYOUT BLOCK */}
                {rating > 0 && (
                ...
                {/* Thank You Card Status Section Banner */}
                {isSubmitted && (
...
const styles = StyleSheet.create({
  ...
  // --- RATING GESTURE BOTTOM SHEET STRUCTURAL STYLES ---
  sheetBackground: {
