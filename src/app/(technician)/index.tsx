...
// Sample internal technician task data
const initialTasks = [
  {
    id: '1',
    customer: 'John Smith',
    type: 'Fiber Loss of Signal',
    time: '10:00 AM',
    priority: 'HIGH',
    status: 'Assigned',
  },
...
export default function Dashboard() {
  ...
  // Helper to color-code task priority pill backgrounds matching the brand UI
  const getPriorityStyles = (priority: string) => {
    switch (priority) {
      case 'HIGH':
        return { container: styles.highPill, text: styles.highPillText };
      case 'MEDIUM':
        return { container: styles.medPill, text: styles.medPillText };
      default:
        return { container: styles.lowPill, text: styles.lowPillText };
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container} edges={['bottom']}>
      ...
      {/* 1. SOLID GREEN CURVED TOP HEADER */}
      <View style={styles.greenHeaderBlock}>
        <View style={styles.headerTopRow}>
          ...
          <TouchableOpacity 
            style={styles.profileRightButton}
        ...
        {/* Floating Toggle Bar Inside Green Header */}
      ...
      >
        ...
        {/* 2. DUAL-ROW METRIC GRID PANELS */}
        <View style={styles.metricsGrid}>
          
          {/* Row 1: Operational Ticket Counters */}
          <View style={styles.metricsRow}>
            <View style={styles.metricCard}>
              <Text style={[styles.metricNumber, { color: '#00b047' }]}>3</Text>
          ...
          {/* Row 2: Performance Evaluation Metrics */}
          <View style={[styles.metricsRow, { marginTop: 10 }]}>
            <View style={styles.metricCard}>
              <View style={styles.labelWithIcon}>
                <Feather name="star" size={14} color="#eab308" style={{ marginRight: 4 }} />
                <Text style={[styles.metricNumber, { color: '#eab308' }]}>4.9</Text>
              </View>
              <Text style={styles.metricLabel}>Rating</Text>
            </View>
            <View style={styles.metricCard}>
              <View style={styles.labelWithIcon}>
                <Feather name="activity" size={14} color="#0066cc" style={{ marginRight: 4 }} />
                <Text style={[styles.metricNumber, { color: '#0066cc' }]}>96%</Text>
              </View>
            ...
            <View key={task.id} style={styles.taskCard}>
              ...
              <View style={styles.taskCardHeader}>
                ...
                <View style={[styles.priorityPill, priorityStyle.container]}>
                  <Text style={[styles.priorityPillText, priorityStyle.text]}>
                    {task.priority}
                  </Text>
                </View>
              </View>
              ...
              {/* Timing & Flow Meta info indicators */}
...
const styles = StyleSheet.create({
  ...
  highPill: { backgroundColor: '#fee2e2' },
  highPillText: { color: '#ef4444' },
  medPill: { backgroundColor: '#fef9c3' },
  medPillText: { color: '#b45309' },
  lowPill: { backgroundColor: '#dcfce7' },
